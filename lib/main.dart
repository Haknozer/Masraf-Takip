      ...
      body: Center(
        child: Column(
          ...
          children: <Widget>[
            ...
            const Text('Masraf Takip Uygulaması', style: TextStyle(fontSize: 24, fontWeight: FontWeight.bold)),
            const SizedBox(height: 10),
            const Text('Grup masraflarınızı kolayca takip edin', style: TextStyle(fontSize: 16, color: Colors.grey)),
